...
class AdminSearchLessonPage extends StatefulWidget {
  const AdminSearchLessonPage({super.key});

  @override
  State<AdminSearchLessonPage> createState() => _AdminSearchLessonPageState();
}

class _AdminSearchLessonPageState extends State<AdminSearchLessonPage> {
                    ...
                    : SizedBox(
                        ...
                        child: const Center(
                          child: Text(
                            ...
                            ' di ripetizioni disponibili è troppo elevato.',
